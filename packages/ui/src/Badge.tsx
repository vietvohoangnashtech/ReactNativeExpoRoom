...
export const Badge: React.FC<BadgeProps> = React.memo(({ label, variant, colorScheme = 'light' }) => {
  const colors = colorScheme === 'dark' ? VARIANT_COLORS_DARK[variant] : VARIANT_COLORS[variant];
